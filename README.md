...
- `input/` - contains MOOSE input files to run grain-scale heat transport simulations
	- `mesh/` - contains mesh generating script and text files with coordiates of the grain at the center
...
- `results/` - contains results of the grain-scale heat transport model
  - `hsf_empirical/` - contains results from the model simulations using the heat transfer coefficient estimated by empirical correlation
