...
# ====== Heat transfer coefficient correlation by Gossler et al. (2020) ======================
dp = 0.005            #[m]
lambda_fl = 0.6       #[W/(m*K)]
Re = ${fparse (rho_f*(q / n)*dp) / mu}
Nu = ${fparse 1 + 3.1 * Re^(0.57)}
hsf_Gossler = ${fparse (Nu*lambda_fl) / dp}
asf = ${fparse 3.14 / dp}
hsf_guess = ${fparse hsf_Gossler * asf}   
# ===============================================================================

T_0 = 300.66          #[K] from BC file '../../data/bc_data/Exp6_05mm_BC_input_temp.csv'
q = 8.7e-05          #[m/s]
...
[Functions]
  [known_T_bc]
    ...
    data_file = '../../data/bc_data/Exp6_05mm_BC_input_temp.csv'
    format = columns
  []
  [K_fcn]
